...
public class Money implements Comparable {
	...
	public Integer universalValue() {
        return this.getCurrency().universalValue(this.getAmount());
	}
	...
	public Money add(Money other) {
        ...
        return new Money((int)nAmount,this.getCurrency());
	}
	...
	public int compareTo(Object other) {
        if (this.universalValue().equals(((Money) other).universalValue())) return 0;
